...
export default function UpdatePost() {
  ...
  const [updatedPostImages, setUpdatedPostImages] = useState(post.images);
 
  const handleChangeContent = (name,value) => {
    setUpdatedPostContent(value)
  }
  const uploadPost = async () => {
    await updatePost(post._id, updatedPostContent, updatedPostImages);
          ...
          <View style={styles.modalView}>
            <View style={styles.mainBody}>
              <TextInput
                ...
                onChangeText={(text) => handleChangeContent('content', text)}
              />
              <ImagesPicker singleFile={updatedPostImages}/>
              ...
              {/* <ImagesPicker singleFile={images} /> */}
